...
if __name__ == "__main__":
    # python train_mc_sample.py --epochs 200 --beta 0.05 --noise True --lr 0.001
    ...
    for i in xrange(args.epochs):
        if (i+1) % 1 == 0:
            ...
            # Compute MI
            curr_mutual_info = mi.compute_mutual_information(gen_outputs["output"].detach().cpu().numpy(), 1000, "output", data_distribution_sampler=data_distr.sample, num_mc_samples=100)
